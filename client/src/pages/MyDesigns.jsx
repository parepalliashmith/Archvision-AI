...
// A designed static "blueprint house" glyph for the card visual — deliberately
// not a live HouseViewer3D per card: mounting one WebGL context per card in a
// grid risks hitting the browser's concurrent-context limit and is real GPU/
// CPU cost for something most of the time nobody's looking at. currentColor so
// it inherits the accent tint set on .design-card-visual.
function HouseGlyph() {
  return (
